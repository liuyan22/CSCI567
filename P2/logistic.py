...
def binary_train(X, y, w0=None, b0=None, step_size=0.5, max_iterations=1000):
    """
    Inputs:
    - X: training features, a N-by-D np array, where N is the 
    number of training points and D is the dimensionality of features
    - y: binary training labels, a N dimensional np array where 
    ...
    Returns:
    - w: D-dimensional vector, a np array which is the weight 
    ...
    for i in range(0, max_iterations):
        ...
        dw = 1/N * np.matmul(X.T, (prob - y))
        db = 1/N * np.sum(prob - y)
        w = w - step_size * dw
        b = b - step_size * db
...
def binary_predict(X, w, b):
    """
    Inputs:
    - X: testing features, a N-by-D np array, where N is the 
    number of training points and D is the dimensionality of features
...
def multinomial_train(X, y, C, 
    ...
    - X: training features, a N-by-D np array, where N is the 
    number of training points and D is the dimensionality of features
    - y: multiclass training labels, a N dimensional np array where
    N is the number of training points, indicating the labels of 
    training data
...
def OVR_train(X, y, C, w0=None, b0=None, step_size=0.5, max_iterations=1000):
    ...
    - X: training features, a N-by-D np array, where N is the 
    number of training points and D is the dimensionality of features
    - y: multiclass training labels, a N dimensional np array, 
